...
//	  Ex1: avdtn sent back to dYdX chain from Osmosis
//	       Packet Denom:      transfer/channel-X/avdtn
//	        -> Remove Prefix: avdtn
//	        -> Leave as is:   avdtn
//
