...
func (PerpetualMarketType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_59691de77210da21, []int{0}
}
...
type Perpetual struct {
	...
	FundingIndex github_com_danielvindax_vd_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=funding_index,json=fundingIndex,proto3,customtype=github.com/danielvindax/vd-chain/protocol/dtypes.SerializableInt" json:"funding_index"`
	// Total size of open long contracts, measured in base_quantums.
	OpenInterest github_com_danielvindax_vd_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,3,opt,name=open_interest,json=openInterest,proto3,customtype=github.com/danielvindax/vd-chain/protocol/dtypes.SerializableInt" json:"open_interest"`
}
...
type PerpetualParams struct {
	...
	MarketType PerpetualMarketType `protobuf:"varint,7,opt,name=market_type,json=marketType,proto3,enum=vindax.perpetuals.PerpetualMarketType" json:"market_type,omitempty"`
}
...
func (*PerpetualParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_59691de77210da21, []int{1}
}
...
func (*MarketPremiums) Descriptor() ([]byte, []int) {
	return fileDescriptor_59691de77210da21, []int{2}
}
...
func (*PremiumStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_59691de77210da21, []int{3}
}
...
func (*LiquidityTier) Descriptor() ([]byte, []int) {
	return fileDescriptor_59691de77210da21, []int{4}
}
...
func init() {
	proto.RegisterEnum("vindax.perpetuals.PerpetualMarketType", PerpetualMarketType_name, PerpetualMarketType_value)
	proto.RegisterType((*Perpetual)(nil), "vindax.perpetuals.Perpetual")
	proto.RegisterType((*PerpetualParams)(nil), "vindax.perpetuals.PerpetualParams")
	proto.RegisterType((*MarketPremiums)(nil), "vindax.perpetuals.MarketPremiums")
	proto.RegisterType((*PremiumStore)(nil), "vindax.perpetuals.PremiumStore")
	proto.RegisterType((*LiquidityTier)(nil), "vindax.perpetuals.LiquidityTier")
}

func init() { proto.RegisterFile("vindax/perpetuals/perpetual.proto", fileDescriptor_59691de77210da21) }

var fileDescriptor_59691de77210da21 = []byte{
	// 762 bytes of a gzipped FileDescriptorProto
	,
}
