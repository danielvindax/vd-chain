...
func (ClobPair_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_b83199580bc4456f, []int{2, 0}
}
...
func (*PerpetualClobMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_b83199580bc4456f, []int{0}
}
...
func (*SpotClobMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_b83199580bc4456f, []int{1}
}
...
type ClobPair struct {
	...
	Status                    ClobPair_Status `protobuf:"varint,7,opt,name=status,proto3,enum=vindax.clob.ClobPair_Status" json:"status,omitempty"`
}
...
func (*ClobPair) Descriptor() ([]byte, []int) {
	return fileDescriptor_b83199580bc4456f, []int{2}
}
...
func init() {
	proto.RegisterEnum("vindax.clob.ClobPair_Status", ClobPair_Status_name, ClobPair_Status_value)
	proto.RegisterType((*PerpetualClobMetadata)(nil), "vindax.clob.PerpetualClobMetadata")
	proto.RegisterType((*SpotClobMetadata)(nil), "vindax.clob.SpotClobMetadata")
	proto.RegisterType((*ClobPair)(nil), "vindax.clob.ClobPair")
}

func init() { proto.RegisterFile("vindax/clob/clob_pair.proto", fileDescriptor_b83199580bc4456f) }

var fileDescriptor_b83199580bc4456f = []byte{
	// 598 bytes of a gzipped FileDescriptorProto
	,
}
