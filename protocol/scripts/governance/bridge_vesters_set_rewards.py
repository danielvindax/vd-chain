...
NATIVE_TOKEN_DENOM="avdtn" # TODO: Replace with production token 
PROPOSAL_BODY="""
...
########################################################################## 
GOV_MODULE_ADDRESS="vindax10d07y265gmmuvt4z0w9aw880jnsr700jntyflm" # Governance module account
COMMUNITY_VESTER_ADDRESS="vindax1wxje320an3karyc6mjw4zghs300dmrjkwr8wzf"
REWARDS_VESTER_ADDRESS="vindax1ltyc6y4skclzafvpznpt2qjwmfwgsndp4y7tj7"
DELAY_MSG_MODULE_ADDRESS="vindax1mkkvp26dngu6n8rmalaxyp3gwkjuzztq5jljzu"
...
proposal_template = {
    ...
    "messages": [
        {
            "@type": "/vindax.sending.MsgSendFromModuleToAccount",
        ...
        {
            "@type": "/vindax.rewards.MsgUpdateParams",
            "authority": GOV_MODULE_ADDRESS,
            "params": {
...
for delayed_block_number, new_fee_multiplier in [
    ...
    proposal_template["messages"].append(
        {
            "@type": "/vindax.delaymsg.MsgDelayMessage",
            "authority": GOV_MODULE_ADDRESS,
            "msg": {
                "@type": "/vindax.rewards.MsgUpdateParams",
