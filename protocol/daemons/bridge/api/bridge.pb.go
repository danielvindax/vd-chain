...
import (
	...
	types "github.com/danielvindax/vd-chain/protocol/x/bridge/types"
...
func (*AddBridgeEventsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_e176ab41bc29c9b4, []int{0}
}
...
func (*AddBridgeEventsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e176ab41bc29c9b4, []int{1}
}
...
func init() {
	proto.RegisterType((*AddBridgeEventsRequest)(nil), "vindax.daemons.bridge.AddBridgeEventsRequest")
	proto.RegisterType((*AddBridgeEventsResponse)(nil), "vindax.daemons.bridge.AddBridgeEventsResponse")
}

func init() {
	proto.RegisterFile("vindax/daemons/bridge/bridge.proto", fileDescriptor_e176ab41bc29c9b4)
}

var fileDescriptor_e176ab41bc29c9b4 = []byte{
	// 268 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *bridgeServiceClient) AddBridgeEvents(ctx context.Context, in *AddBridgeEventsRequest, opts ...grpc.CallOption) (*AddBridgeEventsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/vindax.daemons.bridge.BridgeService/AddBridgeEvents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BridgeService_AddBridgeEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vindax.daemons.bridge.BridgeService/AddBridgeEvents",
	}
...
var _BridgeService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "vindax.daemons.bridge.BridgeService",
	...
	Metadata: "vindax/daemons/bridge/bridge.proto",
}
