...
const (
	...
	// TODO(GENESIS): `avdtn` is a placeholder for the stake token of the dYdX chain.
	// Before this software is published for genesis, `avdtn` should be replaced with
	...
	minGasPriceStakeToken = "25000000000avdtn"
...
func initTendermintConfig() *tmcfg.Config {
	...
	// (https://github.com/vindax/tendermint/blob/dc03b21cf5d54c641e1d14b14fae5920fa7ba656/config/config.go#L982)
