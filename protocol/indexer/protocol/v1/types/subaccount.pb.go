...
func (*IndexerSubaccountId) Descriptor() ([]byte, []int) {
	return fileDescriptor_17da6082d709d09f, []int{0}
}
...
type IndexerPerpetualPosition struct {
	...
	FundingPayment github_com_danielvindax_vd_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,4,opt,name=funding_payment,json=fundingPayment,proto3,customtype=github.com/danielvindax/vd-chain/protocol/dtypes.SerializableInt" json:"funding_payment"`
}
...
func (*IndexerPerpetualPosition) Descriptor() ([]byte, []int) {
	return fileDescriptor_17da6082d709d09f, []int{1}
}
...
func (*IndexerAssetPosition) Descriptor() ([]byte, []int) {
	return fileDescriptor_17da6082d709d09f, []int{2}
}
...
func init() {
	proto.RegisterType((*IndexerSubaccountId)(nil), "vindax.indexer.protocol.v1.IndexerSubaccountId")
	proto.RegisterType((*IndexerPerpetualPosition)(nil), "vindax.indexer.protocol.v1.IndexerPerpetualPosition")
	proto.RegisterType((*IndexerAssetPosition)(nil), "vindax.indexer.protocol.v1.IndexerAssetPosition")
}

func init() {
	proto.RegisterFile("vindax/indexer/protocol/v1/subaccount.proto", fileDescriptor_17da6082d709d09f)
}

var fileDescriptor_17da6082d709d09f = []byte{
	// 412 bytes of a gzipped FileDescriptorProto
	,
}
