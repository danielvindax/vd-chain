...
version_to_url["$PREUPGRADE_VERSION"]="https://github.com/danielvindax/vd-chain/releases/download/protocol%2F$PREUPGRADE_VERSION_FULL_NAME/dydxprotocold-$PREUPGRADE_VERSION_FULL_NAME-linux-amd64.tar.gz"
