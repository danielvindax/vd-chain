...
proto-py-gen: proto-export-deps
	@rm -rf ./proto-py/v4_proto
	@mkdir -p ./proto-py/v4_proto
	@for dir in $(PROTO_DIRS); do \
		python3 -m grpc_tools.protoc \
		-I .proto-export-deps \
		--python_out=./proto-py/v4_proto \
		--pyi_out=./proto-py/v4_proto \
		--grpc_python_out=./proto-py/v4_proto \
