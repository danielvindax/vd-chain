...
impl ::prost::Name for OrderPlaceV1 {
    ...
    const PACKAGE: &'static str = "vindax.indexer.off_chain_updates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.indexer.off_chain_updates.OrderPlaceV1".into()
    }
...
impl ::prost::Name for OrderRemoveV1 {
    ...
    const PACKAGE: &'static str = "vindax.indexer.off_chain_updates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.indexer.off_chain_updates.OrderRemoveV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.indexer.off_chain_updates.OrderRemoveV1".into()
    }
...
impl ::prost::Name for OrderUpdateV1 {
    ...
    const PACKAGE: &'static str = "vindax.indexer.off_chain_updates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.indexer.off_chain_updates.OrderUpdateV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.indexer.off_chain_updates.OrderUpdateV1".into()
    }
...
impl ::prost::Name for OrderReplaceV1 {
    ...
    const PACKAGE: &'static str = "vindax.indexer.off_chain_updates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.indexer.off_chain_updates.OrderReplaceV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.indexer.off_chain_updates.OrderReplaceV1".into()
    }
...
impl ::prost::Name for OffChainUpdateV1 {
    ...
    const PACKAGE: &'static str = "vindax.indexer.off_chain_updates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.indexer.off_chain_updates.OffChainUpdateV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.indexer.off_chain_updates.OffChainUpdateV1".into()
    }
