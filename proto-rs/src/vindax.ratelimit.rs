...
impl ::prost::Name for LimitParams {
    ...
    const PACKAGE: &'static str = "vindax.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.ratelimit.LimitParams".into()
    }
...
impl ::prost::Name for DenomCapacity {
    ...
    const PACKAGE: &'static str = "vindax.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.ratelimit.DenomCapacity".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.ratelimit.DenomCapacity".into()
    }
...
impl ::prost::Name for LimiterCapacity {
    ...
    const PACKAGE: &'static str = "vindax.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.ratelimit.LimiterCapacity".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.ratelimit.LimiterCapacity".into()
    }
...
impl ::prost::Name for GenesisState {
    ...
    const PACKAGE: &'static str = "vindax.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.ratelimit.GenesisState".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.ratelimit.GenesisState".into()
    }
...
impl ::prost::Name for PendingSendPacket {
    ...
    const PACKAGE: &'static str = "vindax.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.ratelimit.PendingSendPacket".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.ratelimit.PendingSendPacket".into()
    }
...
impl ::prost::Name for ListLimitParamsRequest {
    ...
    const PACKAGE: &'static str = "vindax.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.ratelimit.ListLimitParamsRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.ratelimit.ListLimitParamsRequest".into()
    }
...
impl ::prost::Name for ListLimitParamsResponse {
    ...
    const PACKAGE: &'static str = "vindax.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.ratelimit.ListLimitParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.ratelimit.ListLimitParamsResponse".into()
    }
...
impl ::prost::Name for QueryCapacityByDenomRequest {
    ...
    const PACKAGE: &'static str = "vindax.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.ratelimit.QueryCapacityByDenomRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.ratelimit.QueryCapacityByDenomRequest".into()
    }
...
impl ::prost::Name for QueryCapacityByDenomResponse {
    ...
    const PACKAGE: &'static str = "vindax.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.ratelimit.QueryCapacityByDenomResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.ratelimit.QueryCapacityByDenomResponse".into()
    }
...
impl ::prost::Name for QueryAllPendingSendPacketsRequest {
    ...
    const PACKAGE: &'static str = "vindax.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.ratelimit.QueryAllPendingSendPacketsRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.ratelimit.QueryAllPendingSendPacketsRequest".into()
    }
...
impl ::prost::Name for QueryAllPendingSendPacketsResponse {
    ...
    const PACKAGE: &'static str = "vindax.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.ratelimit.QueryAllPendingSendPacketsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.ratelimit.QueryAllPendingSendPacketsResponse".into()
    }
...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("vindax.ratelimit.Query", "ListLimitParams"));
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("vindax.ratelimit.Query", "CapacityByDenom"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("vindax.ratelimit.Query", "AllPendingSendPackets"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
impl ::prost::Name for MsgSetLimitParams {
    ...
    const PACKAGE: &'static str = "vindax.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.ratelimit.MsgSetLimitParams".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.ratelimit.MsgSetLimitParams".into()
    }
...
impl ::prost::Name for MsgSetLimitParamsResponse {
    ...
    const PACKAGE: &'static str = "vindax.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.ratelimit.MsgSetLimitParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.ratelimit.MsgSetLimitParamsResponse".into()
    }
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("vindax.ratelimit.Msg", "SetLimitParams"));
            self.inner.unary(req, path, codec).await
        }
    }
}
