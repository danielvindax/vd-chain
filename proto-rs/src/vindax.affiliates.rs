...
pub mod affiliate_tiers {
    ...
    impl ::prost::Name for Tier {
        ...
        const PACKAGE: &'static str = "vindax.affiliates";
        fn full_name() -> ::prost::alloc::string::String {
            "vindax.affiliates.AffiliateTiers.Tier".into()
        }
...
impl ::prost::Name for AffiliateTiers {
    ...
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.AffiliateTiers".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.AffiliateTiers".into()
    }
...
pub mod affiliate_whitelist {
    ...
    impl ::prost::Name for Tier {
        ...
        const PACKAGE: &'static str = "vindax.affiliates";
        fn full_name() -> ::prost::alloc::string::String {
            "vindax.affiliates.AffiliateWhitelist.Tier".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/vindax.affiliates.AffiliateWhitelist.Tier".into()
        }
...
impl ::prost::Name for AffiliateWhitelist {
    ...
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.AffiliateWhitelist".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.AffiliateWhitelist".into()
    }
...
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct AffiliateParameters {
    /// Maximum attributable volume for a referred user in a 30d rolling window in
    /// notional
    #[prost(uint64, tag = "1")]
    pub maximum_30d_attributable_volume_per_referred_user_quote_quantums: u64,
    /// Referred user automatically gets set to this fee tier
    #[prost(uint32, tag = "2")]
    pub referee_minimum_fee_tier_idx: u32,
    /// Maximum affiliate revenue for a referred user in a 30d rolling window in
    /// quote quantums
    #[prost(uint64, tag = "3")]
    pub maximum_30d_affiliate_revenue_per_referred_user_quote_quantums: u64,
}
impl ::prost::Name for AffiliateParameters {
    const NAME: &'static str = "AffiliateParameters";
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.AffiliateParameters".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.AffiliateParameters".into()
    }
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct AffiliateOverrides {
    /// List of unique whitelisted addresses.
    /// These are automatically put at the maximum affiliate tier
    #[prost(string, repeated, tag = "1")]
    pub addresses: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
}
impl ::prost::Name for AffiliateOverrides {
    const NAME: &'static str = "AffiliateOverrides";
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.AffiliateOverrides".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.AffiliateOverrides".into()
    }
...
pub struct GenesisState {
    ...
    pub affiliate_parameters: ::core::option::Option<AffiliateParameters>,
}
impl ::prost::Name for GenesisState {
    const NAME: &'static str = "GenesisState";
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.GenesisState".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.GenesisState".into()
    }
...
impl ::prost::Name for AffiliateInfoRequest {
    ...
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.AffiliateInfoRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.AffiliateInfoRequest".into()
    }
...
pub struct AffiliateInfoResponse {
    ...
    pub referred_volume_30d_rolling: ::prost::alloc::vec::Vec<u8>,
}
impl ::prost::Name for AffiliateInfoResponse {
    const NAME: &'static str = "AffiliateInfoResponse";
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.AffiliateInfoResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.AffiliateInfoResponse".into()
    }
...
impl ::prost::Name for ReferredByRequest {
    ...
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.ReferredByRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.ReferredByRequest".into()
    }
...
impl ::prost::Name for ReferredByResponse {
    ...
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.ReferredByResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.ReferredByResponse".into()
    }
...
impl ::prost::Name for AllAffiliateTiersRequest {
    ...
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.AllAffiliateTiersRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.AllAffiliateTiersRequest".into()
    }
...
impl ::prost::Name for AllAffiliateTiersResponse {
    ...
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.AllAffiliateTiersResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.AllAffiliateTiersResponse".into()
    }
...
impl ::prost::Name for AffiliateWhitelistRequest {
    ...
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.AffiliateWhitelistRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.AffiliateWhitelistRequest".into()
    }
...
impl ::prost::Name for AffiliateWhitelistResponse {
    ...
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.AffiliateWhitelistResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.AffiliateWhitelistResponse".into()
    }
...
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct AffiliateOverridesRequest {}
impl ::prost::Name for AffiliateOverridesRequest {
    const NAME: &'static str = "AffiliateOverridesRequest";
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.AffiliateOverridesRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.AffiliateOverridesRequest".into()
    }
...
/// Query/AffiliateOverrides RPC method.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct AffiliateOverridesResponse {
    #[prost(message, optional, tag = "1")]
    pub overrides: ::core::option::Option<AffiliateOverrides>,
}
impl ::prost::Name for AffiliateOverridesResponse {
    const NAME: &'static str = "AffiliateOverridesResponse";
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.AffiliateOverridesResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.AffiliateOverridesResponse".into()
    }
...
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct AffiliateParametersRequest {}
impl ::prost::Name for AffiliateParametersRequest {
    const NAME: &'static str = "AffiliateParametersRequest";
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.AffiliateParametersRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.AffiliateParametersRequest".into()
    }
...
/// Query/AffiliateParameters RPC method.
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct AffiliateParametersResponse {
    #[prost(message, optional, tag = "1")]
    pub parameters: ::core::option::Option<AffiliateParameters>,
}
impl ::prost::Name for AffiliateParametersResponse {
    const NAME: &'static str = "AffiliateParametersResponse";
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.AffiliateParametersResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.AffiliateParametersResponse".into()
    }
...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("vindax.affiliates.Query", "AffiliateInfo"));
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("vindax.affiliates.Query", "ReferredBy"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("vindax.affiliates.Query", "AllAffiliateTiers"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("vindax.affiliates.Query", "AffiliateWhitelist"),
                );
            self.inner.unary(req, path, codec).await
        }
        /// Query AffiliateParameters returns the affiliate parameters.
        pub async fn affiliate_parameters(
            &mut self,
            request: impl tonic::IntoRequest<super::AffiliateParametersRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AffiliateParametersResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("vindax.affiliates.Query", "AffiliateParameters"),
                );
            self.inner.unary(req, path, codec).await
        }
        /// Query AffiliateOverrides returns the affiliate overrides.
        pub async fn affiliate_overrides(
            &mut self,
            request: impl tonic::IntoRequest<super::AffiliateOverridesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AffiliateOverridesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("vindax.affiliates.Query", "AffiliateOverrides"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
impl ::prost::Name for MsgRegisterAffiliate {
    ...
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.MsgRegisterAffiliate".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.MsgRegisterAffiliate".into()
    }
...
impl ::prost::Name for MsgRegisterAffiliateResponse {
    ...
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.MsgRegisterAffiliateResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.MsgRegisterAffiliateResponse".into()
    }
...
impl ::prost::Name for MsgUpdateAffiliateTiers {
    ...
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.MsgUpdateAffiliateTiers".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.MsgUpdateAffiliateTiers".into()
    }
...
impl ::prost::Name for MsgUpdateAffiliateTiersResponse {
    ...
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.MsgUpdateAffiliateTiersResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.MsgUpdateAffiliateTiersResponse".into()
    }
...
impl ::prost::Name for MsgUpdateAffiliateWhitelist {
    ...
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.MsgUpdateAffiliateWhitelist".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.MsgUpdateAffiliateWhitelist".into()
    }
...
impl ::prost::Name for MsgUpdateAffiliateWhitelistResponse {
    ...
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.MsgUpdateAffiliateWhitelistResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.MsgUpdateAffiliateWhitelistResponse".into()
    }
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct MsgUpdateAffiliateParameters {
    /// Authority sending this message. Will be sent by gov
    #[prost(string, tag = "1")]
    pub authority: ::prost::alloc::string::String,
...
impl ::prost::Name for MsgUpdateAffiliateParameters {
    const NAME: &'static str = "MsgUpdateAffiliateParameters";
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.MsgUpdateAffiliateParameters".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.MsgUpdateAffiliateParameters".into()
    }
...
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct MsgUpdateAffiliateParametersResponse {}
impl ::prost::Name for MsgUpdateAffiliateParametersResponse {
    const NAME: &'static str = "MsgUpdateAffiliateParametersResponse";
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.MsgUpdateAffiliateParametersResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.MsgUpdateAffiliateParametersResponse".into()
    }
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct MsgUpdateAffiliateOverrides {
    /// Authority sending this message. Will be sent by gov
    #[prost(string, tag = "1")]
    pub authority: ::prost::alloc::string::String,
    /// Addresses that automatically have the maximum affiliate tier
    #[prost(message, optional, tag = "2")]
    pub affiliate_overrides: ::core::option::Option<AffiliateOverrides>,
}
impl ::prost::Name for MsgUpdateAffiliateOverrides {
    const NAME: &'static str = "MsgUpdateAffiliateOverrides";
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.MsgUpdateAffiliateOverrides".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.MsgUpdateAffiliateOverrides".into()
    }
...
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct MsgUpdateAffiliateOverridesResponse {}
impl ::prost::Name for MsgUpdateAffiliateOverridesResponse {
    const NAME: &'static str = "MsgUpdateAffiliateOverridesResponse";
    const PACKAGE: &'static str = "vindax.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.affiliates.MsgUpdateAffiliateOverridesResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.affiliates.MsgUpdateAffiliateOverridesResponse".into()
    }
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("vindax.affiliates.Msg", "RegisterAffiliate"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("vindax.affiliates.Msg", "UpdateAffiliateTiers"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("vindax.affiliates.Msg", "UpdateAffiliateWhitelist"),
                );
            self.inner.unary(req, path, codec).await
        }
        /// UpdateAffiliateParameters updates affiliate program parameters
        pub async fn update_affiliate_parameters(
            &mut self,
            request: impl tonic::IntoRequest<super::MsgUpdateAffiliateParameters>,
        ) -> std::result::Result<
            tonic::Response<super::MsgUpdateAffiliateParametersResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("vindax.affiliates.Msg", "UpdateAffiliateParameters"),
                );
            self.inner.unary(req, path, codec).await
        }
        /// UpdateAffiliateOverrides updates affiliate overrides
        pub async fn update_affiliate_overrides(
            &mut self,
            request: impl tonic::IntoRequest<super::MsgUpdateAffiliateOverrides>,
        ) -> std::result::Result<
            tonic::Response<super::MsgUpdateAffiliateOverridesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("vindax.affiliates.Msg", "UpdateAffiliateOverrides"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
