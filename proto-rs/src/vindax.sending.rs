...
impl ::prost::Name for GenesisState {
    ...
    const PACKAGE: &'static str = "vindax.sending";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.sending.GenesisState".into()
    }
...
impl ::prost::Name for MsgDepositToSubaccount {
    ...
    const PACKAGE: &'static str = "vindax.sending";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.sending.MsgDepositToSubaccount".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.sending.MsgDepositToSubaccount".into()
    }
...
impl ::prost::Name for MsgWithdrawFromSubaccount {
    ...
    const PACKAGE: &'static str = "vindax.sending";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.sending.MsgWithdrawFromSubaccount".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.sending.MsgWithdrawFromSubaccount".into()
    }
...
impl ::prost::Name for MsgSendFromModuleToAccount {
    ...
    const PACKAGE: &'static str = "vindax.sending";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.sending.MsgSendFromModuleToAccount".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.sending.MsgSendFromModuleToAccount".into()
    }
...
impl ::prost::Name for MsgCreateTransfer {
    ...
    const PACKAGE: &'static str = "vindax.sending";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.sending.MsgCreateTransfer".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.sending.MsgCreateTransfer".into()
    }
...
impl ::prost::Name for MsgCreateTransferResponse {
    ...
    const PACKAGE: &'static str = "vindax.sending";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.sending.MsgCreateTransferResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.sending.MsgCreateTransferResponse".into()
    }
...
impl ::prost::Name for MsgDepositToSubaccountResponse {
    ...
    const PACKAGE: &'static str = "vindax.sending";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.sending.MsgDepositToSubaccountResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.sending.MsgDepositToSubaccountResponse".into()
    }
...
impl ::prost::Name for MsgWithdrawFromSubaccountResponse {
    ...
    const PACKAGE: &'static str = "vindax.sending";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.sending.MsgWithdrawFromSubaccountResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.sending.MsgWithdrawFromSubaccountResponse".into()
    }
...
impl ::prost::Name for MsgSendFromModuleToAccountResponse {
    ...
    const PACKAGE: &'static str = "vindax.sending";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.sending.MsgSendFromModuleToAccountResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.sending.MsgSendFromModuleToAccountResponse".into()
    }
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("vindax.sending.Msg", "CreateTransfer"));
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("vindax.sending.Msg", "DepositToSubaccount"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("vindax.sending.Msg", "WithdrawFromSubaccount"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("vindax.sending.Msg", "SendFromModuleToAccount"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
