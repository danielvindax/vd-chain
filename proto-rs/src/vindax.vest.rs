...
impl ::prost::Name for VestEntry {
    ...
    const PACKAGE: &'static str = "vindax.vest";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.vest.VestEntry".into()
    }
...
impl ::prost::Name for QueryVestEntryRequest {
    ...
    const PACKAGE: &'static str = "vindax.vest";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.vest.QueryVestEntryRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.vest.QueryVestEntryRequest".into()
    }
...
impl ::prost::Name for QueryVestEntryResponse {
    ...
    const PACKAGE: &'static str = "vindax.vest";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.vest.QueryVestEntryResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.vest.QueryVestEntryResponse".into()
    }
...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("vindax.vest.Query", "VestEntry"));
...
impl ::prost::Name for MsgDeleteVestEntry {
    ...
    const PACKAGE: &'static str = "vindax.vest";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.vest.MsgDeleteVestEntry".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.vest.MsgDeleteVestEntry".into()
    }
...
impl ::prost::Name for MsgDeleteVestEntryResponse {
    ...
    const PACKAGE: &'static str = "vindax.vest";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.vest.MsgDeleteVestEntryResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.vest.MsgDeleteVestEntryResponse".into()
    }
...
impl ::prost::Name for MsgSetVestEntry {
    ...
    const PACKAGE: &'static str = "vindax.vest";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.vest.MsgSetVestEntry".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.vest.MsgSetVestEntry".into()
    }
...
impl ::prost::Name for MsgSetVestEntryResponse {
    ...
    const PACKAGE: &'static str = "vindax.vest";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.vest.MsgSetVestEntryResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.vest.MsgSetVestEntryResponse".into()
    }
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("vindax.vest.Msg", "SetVestEntry"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("vindax.vest.Msg", "DeleteVestEntry"));
            self.inner.unary(req, path, codec).await
        }
    }
}
