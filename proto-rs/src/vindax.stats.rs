...
impl ::prost::Name for Params {
    ...
    const PACKAGE: &'static str = "vindax.stats";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.stats.Params".into()
    }
...
impl ::prost::Name for GenesisState {
    ...
    const PACKAGE: &'static str = "vindax.stats";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.stats.GenesisState".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.stats.GenesisState".into()
    }
...
pub mod block_stats {
    ...
    pub struct Fill {
        ...
        /// per affiliate tier
        #[prost(uint64, tag = "4")]
        pub affiliate_fee_generated_quantums: u64,
    }
    impl ::prost::Name for Fill {
        const NAME: &'static str = "Fill";
        const PACKAGE: &'static str = "vindax.stats";
        fn full_name() -> ::prost::alloc::string::String {
            "vindax.stats.BlockStats.Fill".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/vindax.stats.BlockStats.Fill".into()
        }
...
impl ::prost::Name for StatsMetadata {
    ...
    const PACKAGE: &'static str = "vindax.stats";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.stats.StatsMetadata".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.stats.StatsMetadata".into()
    }
...
pub mod epoch_stats {
    ...
    impl ::prost::Name for UserWithStats {
        ...
        const PACKAGE: &'static str = "vindax.stats";
        fn full_name() -> ::prost::alloc::string::String {
            "vindax.stats.EpochStats.UserWithStats".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/vindax.stats.EpochStats.UserWithStats".into()
        }
...
pub struct UserStats {
    ...
    #[prost(uint64, tag = "3")]
    pub affiliate_30d_revenue_generated_quantums: u64,
    /// Referred volume in quote quantums with this user being an affiliate
    #[prost(uint64, tag = "4")]
    pub affiliate_30d_referred_volume_quote_quantums: u64,
}
impl ::prost::Name for UserStats {
    const NAME: &'static str = "UserStats";
    const PACKAGE: &'static str = "vindax.stats";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.stats.UserStats".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.stats.UserStats".into()
    }
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CachedStakedBaseTokens {
...
impl ::prost::Name for CachedStakedBaseTokens {
    const NAME: &'static str = "CachedStakedBaseTokens";
    const PACKAGE: &'static str = "vindax.stats";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.stats.CachedStakedBaseTokens".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.stats.CachedStakedBaseTokens".into()
    }
...
impl ::prost::Name for QueryParamsRequest {
    ...
    const PACKAGE: &'static str = "vindax.stats";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.stats.QueryParamsRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.stats.QueryParamsRequest".into()
    }
...
impl ::prost::Name for QueryParamsResponse {
    ...
    const PACKAGE: &'static str = "vindax.stats";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.stats.QueryParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.stats.QueryParamsResponse".into()
    }
...
impl ::prost::Name for QueryStatsMetadataRequest {
    ...
    const PACKAGE: &'static str = "vindax.stats";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.stats.QueryStatsMetadataRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.stats.QueryStatsMetadataRequest".into()
    }
...
impl ::prost::Name for QueryStatsMetadataResponse {
    ...
    const PACKAGE: &'static str = "vindax.stats";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.stats.QueryStatsMetadataResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.stats.QueryStatsMetadataResponse".into()
    }
...
impl ::prost::Name for QueryGlobalStatsRequest {
    ...
    const PACKAGE: &'static str = "vindax.stats";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.stats.QueryGlobalStatsRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.stats.QueryGlobalStatsRequest".into()
    }
...
impl ::prost::Name for QueryGlobalStatsResponse {
    ...
    const PACKAGE: &'static str = "vindax.stats";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.stats.QueryGlobalStatsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.stats.QueryGlobalStatsResponse".into()
    }
...
impl ::prost::Name for QueryUserStatsRequest {
    ...
    const PACKAGE: &'static str = "vindax.stats";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.stats.QueryUserStatsRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.stats.QueryUserStatsRequest".into()
    }
...
impl ::prost::Name for QueryUserStatsResponse {
    ...
    const PACKAGE: &'static str = "vindax.stats";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.stats.QueryUserStatsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.stats.QueryUserStatsResponse".into()
    }
...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut().insert(GrpcMethod::new("vindax.stats.Query", "Params"));
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("vindax.stats.Query", "StatsMetadata"));
            self.inner.unary(req, path, codec).await
        }
        /// Queries GlobalStats.
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("vindax.stats.Query", "GlobalStats"));
            self.inner.unary(req, path, codec).await
        }
        /// Queries UserStats.
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("vindax.stats.Query", "UserStats"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
impl ::prost::Name for MsgUpdateParams {
    ...
    const PACKAGE: &'static str = "vindax.stats";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.stats.MsgUpdateParams".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.stats.MsgUpdateParams".into()
    }
...
impl ::prost::Name for MsgUpdateParamsResponse {
    ...
    const PACKAGE: &'static str = "vindax.stats";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.stats.MsgUpdateParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.stats.MsgUpdateParamsResponse".into()
    }
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("vindax.stats.Msg", "UpdateParams"));
            self.inner.unary(req, path, codec).await
        }
    }
}
