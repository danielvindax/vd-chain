...
impl ::prost::Name for UpdateMarketPricesRequest {
    ...
    const PACKAGE: &'static str = "vindax.daemons.pricefeed";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.daemons.pricefeed.UpdateMarketPricesRequest".into()
    }
...
impl ::prost::Name for UpdateMarketPricesResponse {
    ...
    const PACKAGE: &'static str = "vindax.daemons.pricefeed";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.daemons.pricefeed.UpdateMarketPricesResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.daemons.pricefeed.UpdateMarketPricesResponse".into()
    }
...
impl ::prost::Name for ExchangePrice {
    ...
    const PACKAGE: &'static str = "vindax.daemons.pricefeed";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.daemons.pricefeed.ExchangePrice".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.daemons.pricefeed.ExchangePrice".into()
    }
...
impl ::prost::Name for MarketPriceUpdate {
    ...
    const PACKAGE: &'static str = "vindax.daemons.pricefeed";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.daemons.pricefeed.MarketPriceUpdate".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.daemons.pricefeed.MarketPriceUpdate".into()
    }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "vindax.daemons.pricefeed.PriceFeedService",
                        "UpdateMarketPrices",
                    ),
                );
