...
impl ::prost::Name for AddBridgeEventsRequest {
    ...
    const PACKAGE: &'static str = "vindax.daemons.bridge";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.daemons.bridge.AddBridgeEventsRequest".into()
    }
...
impl ::prost::Name for AddBridgeEventsResponse {
    ...
    const PACKAGE: &'static str = "vindax.daemons.bridge";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.daemons.bridge.AddBridgeEventsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.daemons.bridge.AddBridgeEventsResponse".into()
    }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "vindax.daemons.bridge.BridgeService",
                        "AddBridgeEvents",
                    ),
                );
