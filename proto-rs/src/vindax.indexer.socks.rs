...
impl ::prost::Name for OrderbookMessage {
    ...
    const PACKAGE: &'static str = "vindax.indexer.socks";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.indexer.socks.OrderbookMessage".into()
    }
...
impl ::prost::Name for SubaccountMessage {
    ...
    const PACKAGE: &'static str = "vindax.indexer.socks";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.indexer.socks.SubaccountMessage".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.indexer.socks.SubaccountMessage".into()
    }
...
impl ::prost::Name for TradeMessage {
    ...
    const PACKAGE: &'static str = "vindax.indexer.socks";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.indexer.socks.TradeMessage".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.indexer.socks.TradeMessage".into()
    }
...
impl ::prost::Name for MarketMessage {
    ...
    const PACKAGE: &'static str = "vindax.indexer.socks";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.indexer.socks.MarketMessage".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.indexer.socks.MarketMessage".into()
    }
...
impl ::prost::Name for CandleMessage {
    ...
    const PACKAGE: &'static str = "vindax.indexer.socks";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.indexer.socks.CandleMessage".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.indexer.socks.CandleMessage".into()
    }
...
impl ::prost::Name for BlockHeightMessage {
    ...
    const PACKAGE: &'static str = "vindax.indexer.socks";
    fn full_name() -> ::prost::alloc::string::String {
        "vindax.indexer.socks.BlockHeightMessage".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/vindax.indexer.socks.BlockHeightMessage".into()
    }
